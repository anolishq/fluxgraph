...
struct DimensionVector {
    ...
    bool operator==(const DimensionVector &other) const {
        return m == other.m && l == other.l && t == other.t && i == other.i && theta == other.theta && n == other.n &&
               j == other.j;
    }

    bool operator!=(const DimensionVector &other) const { return !(*this == other); }
};
...
using ParamVariant = std::variant<double, int64_t, bool, std::string, ParamArray, ParamObject>;
