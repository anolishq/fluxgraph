...
public:
    UnitConvertTransform(double scale, double offset) : scale_(scale), offset_(offset) {}
    ...
    ITransform *clone() const override { return new UnitConvertTransform(scale_, offset_); }
