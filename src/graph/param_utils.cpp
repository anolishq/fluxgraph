...
double as_double(const ParamValue &value, const std::string &path) {
    ...
    throw std::runtime_error("Type error at " + path + ": expected number, got " + type_name(value));
}
...
int64_t as_int64(const ParamValue &value, const std::string &path) {
    ...
    throw std::runtime_error("Type error at " + path + ": expected int64, got " + type_name(value));
}
...
bool as_bool(const ParamValue &value, const std::string &path) {
    ...
    throw std::runtime_error("Type error at " + path + ": expected bool, got " + type_name(value));
}
...
std::string as_string(const ParamValue &value, const std::string &path) {
    ...
    throw std::runtime_error("Type error at " + path + ": expected string, got " + type_name(value));
}
...
const ParamArray &as_array(const ParamValue &value, const std::string &path) {
    ...
    throw std::runtime_error("Type error at " + path + ": expected array, got " + type_name(value));
}
...
const ParamObject &as_object(const ParamValue &value, const std::string &path) {
    ...
    throw std::runtime_error("Type error at " + path + ": expected object, got " + type_name(value));
}
